...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.home.category.index', compact('category'))->with('i');
    }
    ...
    {
        $category->delete();
        return redirect()->route('category.index')->with('success', 'Category Data is successfully deleted');
    }
}
